...
Full current keybinding table for `natasha`, generated from
`omarchy menu keybindings --print` (Omarchy defaults + personal overrides in
`hypr/bindings.lua`). Regenerate with that command if this drifts.
